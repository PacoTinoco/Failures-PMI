...
from app.routers import registros, dashboard, equipos, dh, qm, bos_qbos, frr, weekly, ips, qflags, co, inventory
...
app.include_router(qflags.router)
app.include_router(co.router)
