    ...
    <div className="min-h-screen bg-[#0a1628] flex">
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
          <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-blue-500 to-green-500 rounded-xl shadow-lg shadow-blue-500/20">
            <span className="text-sm font-bold text-white">FTO</span>
          </div>
          <div>
            <h1 className="text-base font-bold text-white leading-tight">PMI <span className="text-blue-400">Plattform</span></h1>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden flex items-center gap-3 px-4 py-3 bg-[#0f1d32] border-b border-white/5">
          ...
          <h1 className="text-base font-bold text-white">PMI <span className="text-blue-400">Plattform</span></h1>
        </header>
